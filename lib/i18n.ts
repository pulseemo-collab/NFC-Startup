...
export const t = {
  ...
  orders: "Porositë",
  builder: "Ndërtuesi",
  tabNew: "Porosi të reja",
  tabAll: "Të gjitha",
  markReady: "Shëno si gati për dërgim",
  markDelivered: "Shëno si dërguar",
  emptyNew: "Nuk ka porosi të reja.",
  emptyReady: "Nuk ka porosi gati për dërgim.",
  emptyDelivered: "Ende nuk ka porosi të dërguara.",
  ordersSearchEmpty: "Asnjë rezultat për kërkimin.",
  ordersSearchHint: "Rezultatet e kërkimit (të gjitha statuset)",
  clearSearch: "Pastro",
